...
const cardPopupCloseButton = document.querySelector('.pupup__add-close-icon');
const cardPopup = document.querySelector('.popup_type_add-place');
const cardSubmitButton = document.querySelector('.pupup__button-add-place');
const cardInputName = document.querySelector('.pupup__input_place-name');
const cardInputLink = document.querySelector('.pupup__input_place-link');
const cardPopupForm = document.querySelector('.pupup__form-add-place');
